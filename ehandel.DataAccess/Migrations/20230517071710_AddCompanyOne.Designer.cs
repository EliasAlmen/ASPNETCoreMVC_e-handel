...
namespace ehandel.DataAccess.Migrations
{
    ...
    [Migration("20230517071710_AddCompanyOne")]
    partial class AddCompanyOne
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ehandel.Models.ContactUs", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "John Doe",
                            Phone = "123-456-7890",
                            TimeOfContact = new DateTime(2023, 5, 17, 9, 17, 10, 365, DateTimeKind.Local).AddTicks(7273)
                        });
                });
            ...
            modelBuilder.Entity("ehandel.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDateTime = "2023-05-17 09:17",
