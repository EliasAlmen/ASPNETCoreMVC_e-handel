...
namespace ehandel.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    user.ApplicationUserCompany = checkExistingCompany;
                }
                else
                {
                ...
                else
                {
                    ...
                    var newAddress = new ApplicationUserAddress
                    {
                        StreetName = Input.StreetName,
                        PostalCode = Input.PostalCode,
                        City = Input.City
                    };
                    user.ApplicationUserAddress = newAddress;
                }
